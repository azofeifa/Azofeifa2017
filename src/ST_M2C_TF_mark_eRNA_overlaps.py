...
def main():
	...
	Mark_ChIP_DIR 		= "../files/marks/K562/" 		#directory of bed files
	BIDIR 				= "../files/K562_EMG.bed"
	Ref 					= "../files/TSS.bed"


	OUT 					= "../Tables/STable_to_2C_TF_mark_overlaps_eRNA_counts.csv"
	
	R 						= STP.load_bed_file(Ref)
	B 						= STP.load_bed_file(BIDIR)
	MARKS, IDS 			= STP.get_bed_files( Mark_ChIP_DIR, OUT=None)
	IDS 					= ["eRNA", "Ref"] + IDS
